...
class TestPanoRenderPreviewConsumers(unittest.TestCase):
    def test_runtime_preview_uses_render_core_descriptor(self):
        ...
        self.assertIn('import { buildStickerRenderDescriptor } from "./pano_render_descriptors.js";', runtime_js)
        ...
        self.assertIn("if (!node.__panoStandaloneRuntimeCore) node.__panoStandaloneRuntimeCore = createPanoramaRenderCore();", runtime_js)
        ...
        self.assertIn("node.__panoStandaloneRuntimeCore.syncState(descriptor)", runtime_js)
