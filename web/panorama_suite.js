...
__pano_modules["./pano_gl_renderer.js"] = (__exports, __pano_require) => {
  ...
  __exports.createPanoGlRenderer = createPanoGlRenderer;
};

__pano_modules["./pano_gl_viewport.js"] = (__exports, __pano_require) => {
  const { createPanoGlRenderer } = __pano_require("./pano_gl_renderer.js");
  ...
  function renderSceneToContext2D(options = {}) {
  ...
  function renderErpViewToContext2D(options = {}) {
    let view;
  ...
  function renderCutoutViewToContext2D(options = {}) {
  ...
  __exports.renderSceneToContext2D = renderSceneToContext2D;
  __exports.renderErpViewToContext2D = renderErpViewToContext2D;
  __exports.renderCutoutViewToContext2D = renderCutoutViewToContext2D;
};

__pano_modules["./pano_paint_engine.js"] = (__exports, __pano_require) => {
  ...
  function createPaintEngineManager(options = {}) {
  ...
  __exports.createPaintEngineManager = createPaintEngineManager;
};

__pano_modules["./pano_math.js"] = (__exports, __pano_require) => {
  ...
  __exports.clampSafe = clampSafe;
  __exports.wrapYaw = wrapYaw;
  __exports.shortestYawDelta = shortestYawDelta;
};

__pano_modules["./pano_interaction_controller.js"] = (__exports, __pano_require) => {
  const { clamp, wrapYaw } = __pano_require("./pano_math.js");
  ...
  const PANO_MODAL_PARITY_CONSTANTS = {
  ...
  __exports.createPanoInteractionController = createPanoInteractionController;
  __exports.PANO_DRAG_SENSITIVITY = PANO_DRAG_SENSITIVITY;
  __exports.PANO_WHEEL_STEP = PANO_WHEEL_STEP;
  __exports.PANO_FOV_MIN = PANO_FOV_MIN;
  __exports.PANO_FOV_MAX = PANO_FOV_MAX;
  __exports.PANO_INITIAL_FOV = PANO_INITIAL_FOV;
  __exports.PANO_INERTIA_BLEND_OLD = PANO_INERTIA_BLEND_OLD;
  __exports.PANO_INERTIA_BLEND_INST = PANO_INERTIA_BLEND_INST;
  __exports.PANO_INERTIA_DAMPING = PANO_INERTIA_DAMPING;
  __exports.PANO_INERTIA_START_SPEED = PANO_INERTIA_START_SPEED;
  __exports.PANO_INERTIA_STOP_SPEED = PANO_INERTIA_STOP_SPEED;
  __exports.PANO_MODAL_PARITY_CONSTANTS = PANO_MODAL_PARITY_CONSTANTS;
};

__pano_modules["./pano_preview_identity.js"] = (__exports, __pano_require) => {
  function isPanoramaPreviewNodeName(nameRaw) {
  ...
  __exports.isPanoramaPreviewNodeName = isPanoramaPreviewNodeName;
};

__pano_modules["./pano_cutout_projection.js"] = (__exports, __pano_require) => {
  const { clampSafe: clamp } = __pano_require("./pano_math.js");
  ...
  __exports.getCutoutShotParams = getCutoutShotParams;
  __exports.drawCutoutProjectionPreview = drawCutoutProjectionPreview;
};

__pano_modules["./pano_gl_scene.js"] = (__exports, __pano_require) => {
  const { getCutoutShotParams } = __pano_require("./pano_cutout_projection.js");
  const { clamp } = __pano_require("./pano_math.js");

  
  
  const HIDDEN_PREVIEW_OPACITY = 0.28;
  ...
  function normalizeStickerItem(rawSticker, options = {}) {
  ...
  function buildStickerSceneFromState(state, options = {}) {
  ...
  function buildStickerTexturesFromState(state, assetLoader, options = {}) {
  ...
  function buildPanoramaViewParamsFromEditor(editor) {
    return {
      mode: "panorama",
  ...
  function buildPanoramaViewParamsFromRuntime(runtimeState) {
    return {
      mode: "panorama",
  ...
  function buildPreviewNodeViewParams(nodeState) {
    return buildPanoramaViewParamsFromRuntime(nodeState);
  }
  
  function buildCutoutViewParamsFromShot(shot) {
  ...
  __exports.normalizeStickerItem = normalizeStickerItem;
  __exports.buildStickerSceneFromState = buildStickerSceneFromState;
  __exports.buildStickerTexturesFromState = buildStickerTexturesFromState;
  __exports.buildPanoramaViewParamsFromEditor = buildPanoramaViewParamsFromEditor;
  __exports.buildPanoramaViewParamsFromRuntime = buildPanoramaViewParamsFromRuntime;
  __exports.buildPreviewNodeViewParams = buildPreviewNodeViewParams;
  __exports.buildCutoutViewParamsFromShot = buildCutoutViewParamsFromShot;
  __exports.HIDDEN_PREVIEW_OPACITY = HIDDEN_PREVIEW_OPACITY;
};

__pano_modules["./pano_preview_runtime.js"] = (__exports, __pano_require) => {
  const appModule = __pano_external["../../scripts/app.js"];
  const { api } = __pano_external["../../scripts/api.js"];
  const { renderCutoutViewToContext2D, renderErpViewToContext2D, renderSceneToContext2D } = __pano_require("./pano_gl_viewport.js");
  const { createPaintEngineManager } = __pano_require("./pano_paint_engine.js");
  const { createPanoInteractionController, PANO_DRAG_SENSITIVITY, PANO_WHEEL_STEP, PANO_FOV_MIN, PANO_FOV_MAX, PANO_INERTIA_BLEND_INST, PANO_INERTIA_DAMPING, PANO_INERTIA_START_SPEED, PANO_INERTIA_STOP_SPEED, PANO_MODAL_PARITY_CONSTANTS } = __pano_require("./pano_interaction_controller.js");
  const { clamp, wrapYaw } = __pano_require("./pano_math.js");
  const { isPanoramaPreviewNodeName } = __pano_require("./pano_preview_identity.js");
  const { buildCutoutViewParamsFromShot, buildPanoramaViewParamsFromRuntime, buildStickerSceneFromState, buildStickerTexturesFromState } = __pano_require("./pano_gl_scene.js");
  ...
  const STANDALONE_MESH_LOW = { Nu: 14, Nv: 9 };
  ...
  function localPosFromEvent(node, e, arg2, canvas) {
  ...
  function drawErpBackground(node, ctx, rect, viewBasis, tanHalfY, img, mesh = STANDALONE_MESH_BALANCED) {
  ...
  function lockGraphViewportSnapshot() {
  ...
  function restoreGraphViewportSnapshot(snapshot) {
    if (!snapshot) return;
    const ds = app?.canvas?.ds;
    if (!ds) return;
  ...
  function attachStickersPreviewNode2(node, options = {}) {
  ...
  function attachCutoutPreview(node, options = {}) {
    const controller = getPreviewController(node);
    controller.attach({
      ...options,
      mode: "cutout",
  ...
  function attachStandalonePreviewUnified(node, options = {}) {
    ensureStandalonePreviewBootstrapSize(node);
  ...
  function attachStandalonePreviewDom(node, options = {}) {
  ...
  function attachStandalonePreviewAuto(node, options = {}) {
    attachStandalonePreviewUnified(node, options);
  }
  
  function attachStandalonePreviewLegacy(node, options = {}) {
  ...
  function attachPanoramaPreview(node, options = {}) {
    const allowStandalone = options.__allowStandalone === true;
  ...
  __exports.preferredImageInputsForNode = preferredImageInputsForNode;
  __exports.getLinkedInputImageForPreview = getLinkedInputImageForPreview;
  __exports.localPosFromEvent = localPosFromEvent;
  __exports.drawErpBackground = drawErpBackground;
  __exports.lockGraphViewportSnapshot = lockGraphViewportSnapshot;
  __exports.restoreGraphViewportSnapshot = restoreGraphViewportSnapshot;
  __exports.attachStickersPreviewNode2 = attachStickersPreviewNode2;
  __exports.attachCutoutPreview = attachCutoutPreview;
  __exports.attachStandalonePreviewUnified = attachStandalonePreviewUnified;
  __exports.attachStandalonePreviewDom = attachStandalonePreviewDom;
  __exports.attachStandalonePreviewAuto = attachStandalonePreviewAuto;
  __exports.attachStandalonePreviewLegacy = attachStandalonePreviewLegacy;
  __exports.attachPanoramaPreview = attachPanoramaPreview;
  __exports.STANDALONE_MESH_LOW = STANDALONE_MESH_LOW;
};

__pano_modules["./pano_preview_render.js"] = (__exports, __pano_require) => {
  const { getCutoutShotParams } = __pano_require("./pano_cutout_projection.js");
  const { clamp, wrapYaw, shortestYawDelta } = __pano_require("./pano_math.js");
  ...
  __exports.norm = norm;
  __exports.yawPitchToDir = yawPitchToDir;
  __exports.cameraBasis = cameraBasis;
  __exports.parseState = parseState;
  __exports.DEG2RAD = DEG2RAD;
  __exports.RAD2DEG = RAD2DEG;
  __exports.clamp = clamp;
  __exports.wrapYaw = wrapYaw;
  __exports.shortestYawDelta = shortestYawDelta;
  __exports.getCutoutShotParams = getCutoutShotParams;
...
__pano_modules["./pano_preview_previewnode.js"] = (__exports, __pano_require) => {
  const { app } = __pano_external["../../scripts/app.js"];
  const { api } = __pano_external["../../scripts/api.js"];
  const { cameraBasis, DEG2RAD, clamp, wrapYaw } = __pano_require("./pano_preview_render.js");
  const { createPanoInteractionController } = __pano_require("./pano_interaction_controller.js");
  const { renderSceneToContext2D } = __pano_require("./pano_gl_viewport.js");
  const { buildPreviewNodeViewParams, buildStickerSceneFromState } = __pano_require("./pano_gl_scene.js");
  const { drawErpBackground, STANDALONE_MESH_LOW, localPosFromEvent } = __pano_require("./pano_preview_runtime.js");
  ...
  function attachPreviewNodeRuntime(node, options = {}) {
  ...
  __exports.attachPreviewNodeRuntime = attachPreviewNodeRuntime;
};

__pano_modules["./pano_preview_hooks.js"] = (__exports, __pano_require) => {
  function patchNodeLifecycle(nodeType, key, applyToNode) {
  ...
  __exports.patchNodeLifecycle = patchNodeLifecycle;
};

__pano_modules["./pano_node_preview.js"] = (__exports, __pano_require) => {
  const { attachPanoramaPreview: runtimeAttachPanoramaPreview, attachCutoutPreview: runtimeAttachCutoutPreview } = __pano_require("./pano_preview_runtime.js");
  const { attachPreviewNodeRuntime } = __pano_require("./pano_preview_previewnode.js");
  const { patchNodeLifecycle } = __pano_require("./pano_preview_hooks.js");
  ...
  function attachStickersNodePreview(nodeType, options = {}) {
  ...
  __exports.attachPreviewNode = attachPreviewNode;
  __exports.attachStickersNodePreview = attachStickersNodePreview;
  __exports.attachCutoutPreview = attachCutoutPreview;
};

__pano_modules["./pano_cutout_preview_shared.js"] = (__exports, __pano_require) => {
  const { drawCutoutProjectionPreview } = __pano_require("./pano_cutout_projection.js");
  const { buildCutoutViewParamsFromShot } = __pano_require("./pano_gl_scene.js");

  
  
  function renderSharedCutoutPreview(options = {}) {
    const {
      owner = null,
      ctx = null,
      rect = null,
  ...
  __exports.renderSharedCutoutPreview = renderSharedCutoutPreview;
};

__pano_modules["./pano_brush_presets.js"] = (__exports, __pano_require) => {
  ...
  __exports.applyPresetToStroke = applyPresetToStroke;
  __exports.BRUSH_PRESETS = BRUSH_PRESETS;
  __exports.DEFAULT_BRUSH_PRESET_ID = DEFAULT_BRUSH_PRESET_ID;
};

__pano_modules["./pano_paint_history.js"] = (__exports, __pano_require) => {
  function createHistoryController(limit = 80, initialState = null, serializeLimit = 8) {
    const entries = [];
    let index = -1;
  ...
  __exports.createHistoryController = createHistoryController;
};

__pano_modules["./pano_paint_types.js"] = (__exports, __pano_require) => {
  ...
  function normalizePaintingState(raw) {
  ...
  __exports.normalizePaintingState = normalizePaintingState;
  __exports.emptyPaintingState = emptyPaintingState;
};

__pano_modules["./pano_editor.js"] = (__exports, __pano_require) => {
  const { app } = __pano_external["../../scripts/app.js"];
  const { api } = __pano_external["../../scripts/api.js"];
  const { attachCutoutPreview, attachPreviewNode, attachStickersNodePreview } = __pano_require("./pano_node_preview.js");
  const { isPanoramaPreviewNodeName } = __pano_require("./pano_preview_identity.js");
  const { renderSharedCutoutPreview } = __pano_require("./pano_cutout_preview_shared.js");
  const { renderCutoutViewToContext2D, renderErpViewToContext2D, renderSceneToContext2D } = __pano_require("./pano_gl_viewport.js");
  const { createPanoInteractionController } = __pano_require("./pano_interaction_controller.js");
  const { clamp, wrapYaw, shortestYawDelta } = __pano_require("./pano_math.js");
  const { BRUSH_PRESETS, DEFAULT_BRUSH_PRESET_ID, applyPresetToStroke } = __pano_require("./pano_brush_presets.js");
  const { createHistoryController } = __pano_require("./pano_paint_history.js");
  const { createPaintEngineManager } = __pano_require("./pano_paint_engine.js");
  const { normalizePaintingState } = __pano_require("./pano_paint_types.js");
  const { buildCutoutViewParamsFromShot, HIDDEN_PREVIEW_OPACITY, buildPanoramaViewParamsFromEditor, buildStickerSceneFromState, buildStickerTexturesFromState } = __pano_require("./pano_gl_scene.js");
